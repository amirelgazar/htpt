...
class AutoPlay_PauseButton:
	...
	if autoplaypausebutton:
		...
		if AutoPlay_Pause == "false" and not autoplaypause:
			...
			addonsettings2('plugin.video.genesis','autoplay',"false",'',"",'autoplay_library',"false",'',"",'',"")
