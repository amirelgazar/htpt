...
def CATEGORIES():
	...
	addDir(localize(137),"Go-Pro",3,htptservicemedia_path + "se.png","Search Go-Pro Video",'1',58, getAddonFanart(9))
	addDir('Go-Pro','GoProCamera',9,'https://lh6.ggpht.com/remKtmFiZgZ3yP409xrHZNIIe9M_bV9xEdQM1IOkJw5Ep28lDGVnC7z9iqgv-PsTsHA=w300',"",'1',58, getAddonFanart(9))
	'''Exterme Sport'''
