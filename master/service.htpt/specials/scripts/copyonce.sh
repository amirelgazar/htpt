...
FOLDER_NAME=addons
FOLDER3_PATH=$COPY_PATH/once
FOLDER4_PATH=$MAIN_PATH
if [ -d $FOLDER3_PATH/$FOLDER_NAME ]; then
	cp -f -r $FOLDER3_PATH/$FOLDER_NAME/* $FOLDER4_PATH/$FOLDER_NAME
	echo COPY FOLDER: $FOLDER_NAME
	rm -r $FOLDER3_PATH/$FOLDER_NAME
	echo REMOVING FOLDER: $FOLDER_NAME
fi

###REPEAT###
FOLDER_NAME=addons
FOLDER5_PATH=$COPY_PATH/repeat/
FOLDER6_PATH=$MAIN_PATH
if [ -d $FOLDER5_PATH/$FOLDER_NAME ]; then
	cp -f -r $FOLDER5_PATH/$FOLDER_NAME/* $FOLDER6_PATH/$FOLDER_NAME
	echo COPY FOLDER: $FOLDER_NAME
fi

FOLDER_NAME=userdata
FOLDER7_PATH=$COPY_PATH/repeat/
FOLDER8_PATH=$MAIN_PATH
if [ -d $FOLDER7_PATH/$FOLDER_NAME ]; then
	cp -f -r $FOLDER7_PATH/$FOLDER_NAME/* $FOLDER8_PATH/$FOLDER_NAME
	echo COPY FOLDER: $FOLDER_NAME
fi
#fi
