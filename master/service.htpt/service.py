...
class main:
	...
	while 1 and not xbmc.abortRequested:
		if xbmc.getSkinDir() != 'skin.htpt':
			...
			if Skin_Version == htptskinversion and Skin_UpdateLog == "true" and Skin_UpdateDate != "" and systemidle3 and not playerhasvideo and homeW and not validation and not validation2:
				'''------------------------------
				---setSkin_UpdateLog-------------
				------------------------------'''
				printpoint = ""
			...
			---validationstartup-------------
			------------------------------'''
			#validationstartup(admin, Skin_Name)
			'''---------------------------'''
			...
			if not systemidle300 or not connected or (not connected2 and not connected3):
				...
				if Time_DelayN > 540 and Time_DelayN < 600: #systemidle540 and not systemidle600:
					...
					if count in A10 and not validation and not validation2: screensaver(admin, playerhasvideo)
					'''---------------------------'''
