...
def CATEGORIES101(admin):
	...
	'''חיפוש'''
	addDir(localize(137),commonsearch,3,htptservicemedia_path + "se.png",addonString(3).encode('utf-8') % (commonsearch101),'1',58)
...
def CATEGORIES102(admin):
	...
	'''חיפוש'''
	addDir(localize(137),commonsearch,3,htptservicemedia_path + "se.png",addonString(3).encode('utf-8') % (commonsearch102),'1',58)
...
def CATEGORIES104(admin):
	...
	'''חיפוש'''
	addDir(localize(137),commonsearch,3,htptservicemedia_path + "se.png",addonString(3).encode('utf-8') % (commonsearch104),'1',58)
...
def CATEGORIES111(admin):
	...
	'''חיפוש'''
	addDir(localize(137),commonsearch,3,htptservicemedia_path + "se.png",addonString(3).encode('utf-8') % (commonsearch111),'1',58)
