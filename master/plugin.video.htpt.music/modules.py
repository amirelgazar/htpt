...
def CATEGORIES101(admin):
	...
	'''אביתר בנאי'''
	addDir(addonString(10101).encode('utf-8'),'EviatarBanaiOfficial',9,'http://images.mouse.co.il/storage/7/f/eviatar-ggg.jpg',addonString(101010).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''אברהם טל'''
	addDir(addonString(10102).encode('utf-8'),'avrahamtal',9,'http://images.mouse.co.il/storage/a/d/Avraham_Tal_490.jpg',addonString(101020).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''אייל גולן'''
	addDir(addonString(10103).encode('utf-8'),'EyalGolanOfficial',9,'http://www.atzuma.co.il/uploaded/13112175e8e2be3e53e7dc74153479b3a0c726.jpg',addonString(101030).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''איתי לוי'''
	addDir(addonString(10104).encode('utf-8'),'LevitayOfficial',9,'http://img.mako.co.il/2014/01/20/mooma_itay_levi_beleylot_karim_c.jpg',addonString(101040).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''אליעד'''
	addDir(addonString(10109).encode('utf-8'),'OfficialEliad',9,'http://img.mako.co.il/2015/07/15/GGkfkf5_c.jpg',addonString(101090).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''אתניקס'''
	addDir(addonString(10105).encode('utf-8'),'EthnixOfficial',9,'http://img.mako.co.il/2013/05/21/etnix_prn_c.jpg',addonString(101050).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
		
	'''ברי סחרוף'''
	addDir(addonString(10106).encode('utf-8'),'sakharofficial',9,'http://img.mako.co.il/2010/10/22/dan_toren_15c.jpg',addonString(101060).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
		
	'''גיא ויהל'''
	addDir(addonString(10108).encode('utf-8'),'GuyYahelOfficial',9,'http://i.ytimg.com/vi/9fkcGdgj-iI/hqdefault.jpg',addonString(101080).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''דודו אהרון'''
	addDir(addonString(10107).encode('utf-8'),'DuduAharonOfficiaI',9,'http://www.klr-lior.com/wp-content/gallery/omanim/dudu_aharon-hero_c.jpg',addonString(101070).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
		
	'''דודו טסה'''
	addDir(addonString(10110).encode('utf-8'),'DuduTassaOfficial',9,'http://www.nrg.co.il/images/archive/465x349/1/028/989.jpg',addonString(101100).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))

	'''דני סנדרסון'''
	addDir(addonString(10111).encode('utf-8'),'PLWs5r3WqRUR0kiPs-hou6gtDbj9qlUBK_',13,'http://images1.calcalist.co.il/PicServer2/20122005/158200/YE0415562_l.jpg',addonString(101110).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
			
	'''הפרויקט של רביבו'''
	addDir(addonString(10112).encode('utf-8'),'TheRevivoProject',9,'http://img.mako.co.il/2012/08/23/revivo_project_purple_c.jpg',addonString(101120).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''הראל סקעת'''
	addDir(addonString(10113).encode('utf-8'),'skaatharel',9,'https://i.ytimg.com/i/BbOw6LiHmj6L9o_HlMvKKg/mq1.jpg?v=51c9be2d',addonString(101130).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''חיים משה'''
	addDir(addonString(10114).encode('utf-8'),'haimmosheoffical',9,'http://images.one.co.il/images/mag/450_250/gg789176.jpg',addonString(101140).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''יהושוע אהרון'''
	addDir(addonString(10115).encode('utf-8'),'worshipinisrael',9,'https://yt3.ggpht.com/-ohYJ_SZGouY/AAAAAAAAAAI/AAAAAAAAAAA/WTRKUc-dpwE/s100-c-k-no/photo.jpg',addonString(101150).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))	
	...
	'''ליאור נרקיס'''
	addDir(addonString(10118).encode('utf-8'),'LiorNarkisOfficial',9,'http://bsn.co.il/sites/default/files/styles/home_page_main_story_image_480x269/public/%D7%9C%D7%99%D7%90%D7%95%D7%A8%20%D7%A0%D7%A8%D7%A7%D7%99%D7%A1.jpg?itok=nVnP8pg-',addonString(101180).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''לירן דנינו'''
	addDir(addonString(10119).encode('utf-8'),'LiranDaninoMusic',9,'https://i.ytimg.com/i/vYVVsleioHXLy08I8LmVCQ/mq1.jpg?v=55057e3c',addonString(101190).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''מאיה בוסקילה'''
	addDir(addonString(10120).encode('utf-8'),'mayabos',9,'https://yt3.ggpht.com/-5PEvWjlVLN4/AAAAAAAAAAI/AAAAAAAAAAA/tNQGMUjQfxE/s100-c-k-no/photo.jpg',addonString(101200).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
		
	'''מוש בן ארי'''
	addDir(addonString(10121).encode('utf-8'),'MoshBA1',9,'http://www.nrg.co.il/images/archive/408x322/692/069.jpg',addonString(101210).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))

	'''מושיק עפיה'''
	addDir(addonString(10122).encode('utf-8'),'MoshikAfiaOfficial',9,'https://yt3.ggpht.com/-4IayEL0C0Rs/AAAAAAAAAAI/AAAAAAAAAAA/kEV66on9DOM/s100-c-k-no/photo.jpg',addonString(101220).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''מירי מסיקה'''
	addDir(addonString(10123).encode('utf-8'),'MiriMesikaOfficial',9,'https://i.ytimg.com/i/7cwmZGtlWPDkkEWsxkZd-Q/mq1.jpg?v=54998b82',addonString(101230).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
		
	'''מאור אדרי'''
	addDir(addonString(10124).encode('utf-8'),'MaorEdriOfficiial',9,'http://img.mako.co.il/2012/09/12/maor_edri_suit_c.jpg',addonString(101240).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''משה פרץ'''
	addDir(addonString(10125).encode('utf-8'),'MoshePerezOfficial',9,'https://i.ytimg.com/i/0ebT4a-IyuY61X8py3nzsg/mq1.jpg?v=52124db3',addonString(101250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''נתן גושן'''
	addDir(addonString(10127).encode('utf-8'),'NathanGoshenOfficial',9,'https://i.ytimg.com/i/Bh-trCMk-XPOP7WgAdkpPg/mq1.jpg?v=54d87328',addonString(101270).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''סאבלימינל'''
	addDir(addonString(10128).encode('utf-8'),'SubliminalOfficial',9,'https://yt3.ggpht.com/-BnbsgmTB25g/AAAAAAAAAAI/AAAAAAAAAAA/mUFJQWSaKA8/s100-c-k-no/photo.jpg',addonString(101280).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''סטלוס ואורן חן'''
	addDir(addonString(10129).encode('utf-8'),'plugin://plugin.video.youtube/channel/UClhlTKsREdNMKga6_I2dFyQ/',8,'https://yt3.ggpht.com/-2gpbz_o3W7I/AAAAAAAAAAI/AAAAAAAAAAA/PfzwwLycsmo/s100-c-k-no/photo.jpg',addonString(101290).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''עברי לידר'''
	addDir(addonString(10130).encode('utf-8'),'IvriLiderOfficial',9,'http://media.shironet.mako.co.il/media/performers/heb/0/764/profile/764_t275.jpg?rnd=58',addonString(101300).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''עידן רפאל חביב'''
	addDir(addonString(10131).encode('utf-8'),'baswaka9',9,'https://yt3.ggpht.com/-l9mhWhO0kT8/AAAAAAAAAAI/AAAAAAAAAAA/iv1toJVFwSQ/s100-c-k-no/photo.jpg',addonString(101310).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''עידן רייכל'''
	addDir(addonString(10132).encode('utf-8'),'idanraichelofficial',9,'https://yt3.ggpht.com/-vsBWN1RBQuk/AAAAAAAAAAI/AAAAAAAAAAA/SWZEbbG5oUY/s100-c-k-no/photo.jpg',addonString(101320).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))

	'''עומר אדם'''
	addDir(addonString(10133).encode('utf-8'),'OmerAdamOfficial',9,'https://i.ytimg.com/i/o4y7A6EF2tZ1Q2Oxx64HNQ/mq1.jpg?v=520b5fde',addonString(101330).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''עמיר בניון'''
	addDir(addonString(10134).encode('utf-8'),'nevelasorpr',9,'http://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Amir_Benayoun.JPG/450px-Amir_Benayoun.JPG',addonString(101340).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))

	'''פאר טסי'''
	addDir(addonString(10135).encode('utf-8'),'peertasimizrahi',9,'https://yt3.ggpht.com/-XdArdL_W374/AAAAAAAAAAI/AAAAAAAAAAA/phGLZNk8iwU/s100-c-k-no/photo.jpg',addonString(101350).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קובי אפללו'''
	addDir(addonString(10136).encode('utf-8'),'TheKobiAflalo',9,'https://yt3.ggpht.com/-W5wjK70SQ1U/AAAAAAAAAAI/AAAAAAAAAAA/Ibov9BPmodU/s100-c-k-no/photo.jpg',addonString(101360).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קובי פרץ'''
	addDir(addonString(10137).encode('utf-8'),'KobiPeretzOfficial',9,'https://i.ytimg.com/i/GYqX6zfso91VDawbH_Nukw/mq1.jpg?v=4f5f486f',addonString(101370).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קרן פלס'''
	addDir(addonString(10138).encode('utf-8'),'KerenPelesOfficial',9,'http://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/KerenPelesNew.jpg/375px-KerenPelesNew.jpg',addonString(101380).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''ריטה'''
	addDir(addonString(10139).encode('utf-8'),'ritaofficial',9,'http://img.mako.co.il/2013/02/07/rita_promo_bww_c.jpg',addonString(101390).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''רמי קליינשטיין'''
	addDir(addonString(10140).encode('utf-8'),'RamiKleinshteinMusic',9,'http://images1.ynet.co.il/PicServer2/28102008/1770103/2_wh.jpg',addonString(101400).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''שירי מימון'''
	addDir(addonString(10141).encode('utf-8'),'ShiriMaimonOfficial',9,'http://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Sm_album3.jpg/250px-Sm_album3.jpg',addonString(101410).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''שלום חנוך'''
	addDir(addonString(10142).encode('utf-8'),'ShalomHanoch',9,'https://yt3.ggpht.com/-6DiGw2l8Nrk/AAAAAAAAAAI/AAAAAAAAAAA/3qnrk75SjaA/s100-c-k-no/photo.jpg',addonString(101420).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))

	'''שלומי שבת'''
	addDir(addonString(10143).encode('utf-8'),'shlomishabatofficiaI',9,'https://i.ytimg.com/i/GaHPMv8YIv_0HfRDQQ44cA/mq1.jpg?v=af5444',addonString(101430).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''שלמה ארצי'''
	addDir(addonString(10144).encode('utf-8'),'ShlomoArtziOfficial',9,'http://www.nrg.co.il/images/archive/465x349/1/403/734.jpg',addonString(101440).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''שרית חדד'''
	addDir(addonString(10145).encode('utf-8'),'SaritHadadOfficial',9,'https://i.ytimg.com/i/0m-czKbg-tL7J61RDdU1rg/mq1.jpg?v=54ac3da1',addonString(101450).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	''''''
	#addDir(addonString(10146).encode('utf-8'),'',9,'',addonString(101460).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
...
def CATEGORIES111(admin):
	...
	'''Bob Dylan'''
	addDir(addonString(11123).encode('utf-8'),'plugin://plugin.video.youtube/channel/UCBqkojCXby4zGkWX86FEY7Q/',8,"http://www.rockbandaide.com/wp-content/uploads/2014/02/Bob-Dylan-Times-are-Changing-C10113356.jpg",addonString(111230).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Britney Spears'''
	addDir(addonString(11150).encode('utf-8'),'BritneySpearsVEVO',9,"http://guardianlv.com/wp-content/uploads/2013/12/Britney-Spears-Hits-Vegas-With-Piece-of-Me-Concert-Series-e1388228163153.jpg",addonString(111500).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Celine Dion'''
	
	'''Coldplay'''
	addDir(addonString(11129).encode('utf-8'),'ColdplayVEVO',9,"http://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Coldplay-3.jpg/429px-Coldplay-3.jpg",addonString(111290).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Chris" Brown'''
	addDir(addonString(11116).encode('utf-8'),'ChrisBrownVEVO',9,"http://factmag-images.s3.amazonaws.com/wp-content/uploads/2015/09/chris_brown270915.jpg",addonString(111160).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Elvis Presley'''
	addDir(addonString(11120).encode('utf-8'),'ElvisPresleyVEVO',9,"http://static.europosters.cz/image/750/plakatok/elvis-presley-portrait-i9038.jpg/375px-Elvis_Presley_promoting_Jailhouse_Rock.jpg",addonString(111200).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Eric Clapton'''
	addDir(addonString(11124).encode('utf-8'),'plugin://plugin.video.youtube/channel/UCXmEE051j5RhUENn7saUF3g/',8,"http://rock.amazingradios.com/wp-content/uploads/2014/10/eric-clapton-9.jpg",addonString(111240).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Eminem'''
	addDir(addonString(11138).encode('utf-8'),'EminemVEVO',9,"http://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Eminem_performing_live_at_dj_hero_party.jpg/375px-Eminem_performing_live_at_dj_hero_party.jpg",addonString(111380).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Jennifer Lopez'''
	addDir(addonString(11118).encode('utf-8'),'JenniferLopezVEVO',9,"http://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Jennifer_Lopez_GLAAD_2014.jpg/375px-Jennifer_Lopez_GLAAD_2014.jpg",addonString(111180).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Michael Jackson'''
	addDir(addonString(11101).encode('utf-8'),'plugin://plugin.video.youtube/channel/UCulYu1HEIa7f70L2lYZWHOw/',8,"http://factmag-images.s3.amazonaws.com/wp-content/uploads/2013/05/beyonce-5.13.20132.jpg/375px-Michael_Jackson_in_1988.jpg",addonString(111010).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Mariah Carey'''
	addDir(addonString(11113).encode('utf-8'),'MariahCareyVEVO',9,"http://www.studentsoftheworld.info/sites/musique/img/2827_Maria_Carey_1.jpg",addonString(111130).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Maroon5'''
	addDir(addonString(11125).encode('utf-8'),'Maroon5VEVO',9,"http://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Maroon_5%2C_2011.jpg/390px-Maroon_5%2C_2011.jpg",addonString(111250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Roy Orbison'''
	addDir(addonString(11110).encode('utf-8'),'http://www.songs-tube.net/12664-Roy%20Orbison.html',9,"http://www.billboard.com/files/styles/promo_650/public/stylus/1077939-roy-orbison-617-409.jpg",addonString(111100).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Rihanna'''
	addDir(addonString(11103).encode('utf-8'),'RihannaVEVO',9,"http://static1.1.sqspcdn.com/static/f/610086/15180915/1321583897117/Rihanna.jpg?token=kZt1lYEul%2FfTahdORTKehFd28NI%3D/site1/20091127/0023ae9885da0c7990e10d.jpg&pw=200",addonString(111030).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Whitney Houston'''
	addDir(addonString(11114).encode('utf-8'),'whitneyhoustonVEVO',9,"http://img2.timeinc.net/people/i/2012/specials/yearend/obits/whitney-houston-1435.jpg",addonString(111140).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
...
def CATEGORIES112(admin):
	...
	background = 112
	'''מלך הקריוקי'''
	addDir(addonString(1201).encode('utf-8'),'singkingkaraoke',9,"https://yt3.ggpht.com/-RQAPMaxL1gE/AAAAAAAAAAI/AAAAAAAAAAA/zawPgoguLwI/s100-c-k-no/photo.jpg",addonString(1251).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''ערוץ הקריוקי'''
	addDir(addonString(1202).encode('utf-8'),'TheKARAOKEChannel',9,"https://yt3.ggpht.com/-8Ee1BcZtW7g/AAAAAAAAAAI/AAAAAAAAAAA/JqoBo946g0Q/s100-c-k-no/photo.jpg",addonString(1252).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''כיף לי קריוקי'''
	addDir(addonString(1203).encode('utf-8'),'karafun',9,"https://i.ytimg.com/i/bqcG1rdt9LMwOJN4PyGTKg/mq1.jpg?v=510a8aea",addonString(1253).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''שיר שיר קריוקי'''
	addDir(addonString(1204).encode('utf-8'),'singsongsmusic',9,"https://yt3.ggpht.com/-iu_A8aYydvs/AAAAAAAAAAI/AAAAAAAAAAA/kXj4XMpmVnI/s100-c-k-no/photo.jpg",addonString(1254).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''VEVO קריוקי'''
	addDir(addonString(1205).encode('utf-8'),'KaraokeOnVEVO',9,"https://yt3.ggpht.com/-CyAdZgF4lts/AAAAAAAAAAI/AAAAAAAAAAA/c181cY8p6Lc/s100-c-k-no/photo.jpg",addonString(1255).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Matt Monro Karaoke'''
	addDir(addonString(1206).encode('utf-8'),'PLLDeS1DKrNwyPjDuzHsoJiw4-rWn97Umq',13,"http://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Matt_Monro.png/220px-Matt_Monro.png",addonString(1256).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 1'''
	addDir(addonString(112).encode('utf-8') + space + "1",'PL5MV8_qxHC5u8I2IrcHWQQ_yLGIcAlOy7',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 2'''
	addDir(addonString(112).encode('utf-8') + space + "2",'PL5MV8_qxHC5s4l6yy6FGD2VnK-zYdZm0J',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 3'''
	addDir(addonString(112).encode('utf-8') + space + "3",'PLB52171717111CFFA',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 4'''
	addDir(addonString(112).encode('utf-8') + space + "4",'PLsNRPB4qRXumn6Y7BkkN5pJqWNa3Gd7LX',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 5 (2015)'''
	addDir(addonString(112).encode('utf-8') + space + "5" + space + "(2015)",'PLjWNGcq3dvNYt9SyA9f3vxmdMe10xnSOL',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 6 (2014)'''
	addDir(addonString(112).encode('utf-8') + space + "6" + space + "(2014)",'PLjWNGcq3dvNY23wYDKeYIZqurM60izBqm',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''קריוקי לועזי 7 (2013)'''
	addDir(addonString(112).encode('utf-8') + space + "7" + space + "(2013)",'PLjWNGcq3dvNYdBUwW0zrNAnyg0-TaYDV-',13,"special://skin/media/icons/karaoke.png",addonString(1250).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
