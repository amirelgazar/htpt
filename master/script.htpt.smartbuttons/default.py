...
class main:
	...
	if mode == 0:
		...
		---TOGGLE-ADULT-BUTTON-----------
		------------------------------'''
		name = "TOGGLE-ADULT-BUTTON"
		mode38(admin, name, printpoint)
		'''---------------------------'''
		...
		if mode == 200:
			...
			mode203(value, admin, admin3, name, printpoint)
			'''---------------------------'''
		...
		if mode == 350:
			...
			------------------------------'''
			name = "MESSAGE-BUTTON"
			mode351(admin, admin2, admin3, name, printpoint)
			'''---------------------------'''
		...
		if mode == 500:
			...
			name = "MOVIESE-BUTTON"
			if not connected: printpoint = printpoint + "D/C"
			else: printpoint = mode506(value, admin, name, printpoint)
			'''---------------------------'''
			...
			---TVSHOWSE-BUTTON---------------
			------------------------------'''
			name = "TVSHOWSE-BUTTON"
			if not connected: printpoint = printpoint + "D/C"
			else: printpoint = mode507(value, admin, name, printpoint)
			'''---------------------------'''
	...
	if "D/C" in printpoint and not "9" in printpoint: notification_common("5")
	...
	if admin: print printfirst + "default.py_LV" + printpoint + space + "mode" + space2 + str(mode) + space + "value" + space2 + str(value) + space + "General_ScriptON" + space2 + General_ScriptON
