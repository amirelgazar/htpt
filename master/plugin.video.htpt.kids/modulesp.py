...
def CATEGORIES():
	...
	---MAIN--------------------------
	------------------------------'''
	addDir(addonString(101).encode('utf-8'),'',101,addonMediaPath + "41.png",addonString(1001).encode('utf-8'),'1',58, getAddonFanart(101)) #SONGS AND STORIES
	addDir(addonString(102).encode('utf-8'),'',102,addonMediaPath + "42.jpg",addonString(1002).encode('utf-8'),'1',58, getAddonFanart(102)) #SHOWS
	addDir(addonString(104).encode('utf-8'),'',104,addonMediaPath + "44.png",addonString(1004).encode('utf-8'),'1',58, getAddonFanart(104)) #TV SHOWS
	addDir(addonString(105).encode('utf-8'),'',105,addonMediaPath + "45.jpg",addonString(1005).encode('utf-8'),'1',50, getAddonFanart(105)) #MOVIES
	addDir(addonString(106).encode('utf-8'),'',106,addonMediaPath + "46.png",addonString(1006).encode('utf-8'),'1',58, getAddonFanart(106)) #
	addDir(addonString(107).encode('utf-8'),'',107,addonMediaPath + "47.jpg",addonString(1007).encode('utf-8'),'1',58, getAddonFanart(107)) #Tiny
	addDir(addonString(108).encode('utf-8'),'',108,addonMediaPath + "48.jpg",addonString(1008).encode('utf-8'),'1',50, getAddonFanart(108)) #Kids and Young
	addDir(addonString(109).encode('utf-8'),'',109,addonMediaPath + "49.jpg",addonString(1009).encode('utf-8'),'1',50, getAddonFanart(109)) #
...
def CATEGORIES101(admin):
	...
	addDir('שירי עוזי חיטמן',['&wallaNew=item_id%3D2538763', '&youtube_pl=21zlKTnPBcU&list=RD21zlKTnPBcU', '&youtube_pl=PL0145D27A0D5E1810', '&youtube_id=YMLsE_DMPGQ', '&youtube_id=21zlKTnPBcU'],17,'http://www.lifemusic.co.il/files/singers/big/1248883756s56Ly.jpg',addonString(110).encode('utf-8'),'1',50, getAddonFanart(background))
...
def CATEGORIES104(admin):
	...
	addDir(localize(22082),list,6,addonMediaPath + 'buttonadd.png',addonString(110).encode('utf-8'),'1',50, getAddonFanart(background)) ; list = []
	'''---------------------------'''
	...
	'''דורימון'''
	addDir("דורימון",['&youtube_pl=PL95CWWe9DuaJ6xtv1V8ZxDvoG_cB3z4bc'],17,'http://www.animation-animagic.com/img/conteudo/2632008151425.jpg',addonString(110).encode('utf-8'),'1',"", getAddonFanart(background))
	...
	addDir('פיקסי (רוסית)',list,17,'http://www.youloveit.ru/uploads/gallery/main/791/youloveit_ru_fixiki_kartinki18.jpg','','1',50, getAddonFanart(background))
...
def CATEGORIES107(admin):
	...
	addDir(localize(22082),list,6,addonMediaPath + 'buttonadd.png',addonString(194).encode('utf-8'),'1',50, getAddonFanart(background)) ; list = []
	'''---------------------------'''
	...
	addDir(addonString(10709).encode('utf-8') + space + "(" + addonString(205).encode('utf-8') + ")",list,17,'https://upload.wikimedia.org/wikipedia/ru/4/4d/%D0%91%D0%B0%D1%80%D0%B1%D0%BE%D1%81%D0%BA%D0%B8%D0%BD%D1%8B.png',addonString(107090).encode('utf-8'),'1',50, getAddonFanart(background))
...
def CATEGORIES109(admin):
	background = 109
	'''קטנטנים בהולנדית 1'''
	addDir(addonString(107).encode('utf-8') + space + "(" + addonString(202).encode('utf-8') + ")" + "1",'UCMf-gZNpJSPq80r9e22wl9A',9,'http://yt3.ggpht.com/-BXNeRxPOFpU/AAAAAAAAAAI/AAAAAAAAAAA/3DZSjgkhfJM/s88-c-k-no/photo.jpg',addonString(110).encode('utf-8'),'1',"", getAddonFanart(background))
	
	'''קטנטנים באוקראינית 1'''
	addDir(addonString(107).encode('utf-8') + space + "(" + addonString(203).encode('utf-8') + ")" + "1",'UCZAL3xoDj13SeJGTFhq00Tw',9,'http://yt3.ggpht.com/-TrrOJ-NiNys/AAAAAAAAAAI/AAAAAAAAAAA/lhx315yY5gs/s88-c-k-no/photo.jpg',addonString(110).encode('utf-8'),'1',"", getAddonFanart(background))
	
	'''שירים בצרפתית 1'''
	addDir(addonString(57).encode('utf-8') + space + "(" + addonString(204).encode('utf-8') + ")" + "1",'comptines',9,'https://yt3.ggpht.com/-MT6ThcO_qNI/AAAAAAAAAAI/AAAAAAAAAAA/GDibk7v0-FA/s100-c-k-no/photo.jpg',addonString(110).encode('utf-8'),'1',"", getAddonFanart(background))
	...
	'''סי בייביס באנגלית'''
	addDir(addonString(63).encode('utf-8') + space + "(" + addonString(201).encode('utf-8') + ")",'UC0fXNmjDoC7ckPyT6qM8Urw',9,'http://yt3.ggpht.com/-lrofuJsz1c8/AAAAAAAAAAI/AAAAAAAAAAA/8YJ0rAktf_o/s88-c-k-no/photo.jpg',addonString(163).encode('utf-8'),'1',"", getAddonFanart(background))
