...
''' % (scripthtptinstall_User_ID, id1str)
...
''' % (scripthtptinstall_User_ID, User_Name, User_Issue, systemuptime)
...
''' % (id2str, id3str, id4str, id5str, id6str, id8str, id10str, scripthtptdebug_Info_Model, scripthtptdebug_Info_Intel, scripthtptdebug_Info_TotalSpace, fixip, id40str)
...
AVAILABLE DATE:    %s
------------------------------
''' % (verrorstr, servicehtptfix_Fix_Done, servicehtptfix_Fix_LastDate)
...
TRIAL DATE:   	   %s - %s
TRIAL 1/2:    	   %s - %s
TRIAL END/RENEWED: %s - %s
------------------------------
''' % (trialdate, trialdate2, trial, trial2, Sum_3, Sum_2)
